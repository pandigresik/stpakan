var ppn = {
	...
	tampilkan_data : function(){
		...
		$.ajax({
			url : 'report/Laporan_pakan_per_nama/get_laporan',
			type : 'POST',
			data : {
				farm_post		: farm,
	...
	set_list_periode : function(){
		...
		$.ajax({
			url : 'report/Laporan_pakan_per_nama/get_list_periode',
			type : 'POST',
			data : {kodefarm : $farm},
			dataType : 'JSON',
			success : function(data){
	...
	set_list_kandang : function(){
		...
		$farm = $('#select_farm').val();
		$.ajax({
			url : 'report/Laporan_pakan_per_nama/get_kandang_farm',
			type : 'POST',
			data : {kodefarm : $farm},
			dataType : 'JSON',
			success : function(data){
