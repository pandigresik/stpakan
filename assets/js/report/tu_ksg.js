              ...
              if(result){
                  if(_nextStatus == 'RJ'){
                      var box2 = bootbox.confirm({
                          message: "Mohon Mengisi Keterangan Reject <b>(min. 10 karakter)</b><textarea onkeyup='KSG.check_keterangan(this)' class='bootbox-input bootbox-input-textarea form-control' id='keterangan_reject'></textarea>",
                          buttons: {
                              confirm: {
                                  label: 'Simpan',
