        ...
        for (var y in _result) {
            if (y == 0) {
                ...
                if(_maxGantiPakan <= 0){
                    ...
                    _komposisiGantiPakan[_umur - 1]["pakanLama"] = { "kode_pakan": _pakanLama["kode_pakan"], "komposisi": 1, "nama_barang": _pakanLama["nama_barang"], "bentuk": _pakanLama["bentuk"] };
                    _komposisiGantiPakan[_umur - 1]["pakanBaru"] = { "kode_pakan": '', "komposisi": 0, "nama_barang": '', "bentuk": '' };
                    _komposisiGantiPakan[_umur] = {};
                    _komposisiGantiPakan[_umur]["pakanLama"] = { "kode_pakan": _pakanLama["kode_pakan"], "komposisi": 1, "nama_barang": _pakanLama["nama_barang"], "bentuk": _pakanLama["bentuk"] };
                    _komposisiGantiPakan[_umur]["pakanBaru"] = { "kode_pakan": '', "komposisi": 0, "nama_barang": '', "bentuk": '' };
                    _komposisiGantiPakan[parseInt(_umur) + 1] = {};
                    _komposisiGantiPakan[parseInt(_umur) + 1]["pakanLama"] = { "kode_pakan": _pakanLama["kode_pakan"], "komposisi": 1, "nama_barang": _pakanLama["nama_barang"], "bentuk": _pakanLama["bentuk"] };
                    _komposisiGantiPakan[parseInt(_umur) + 1]["pakanBaru"] = { "kode_pakan": '', "komposisi": 0, "nama_barang": '', "bentuk": '' };
                }
