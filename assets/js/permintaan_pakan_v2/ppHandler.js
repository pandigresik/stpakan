...
var Permintaan = {
    ...
    load_farm: function(elm) {
        ...
        if (!empty(id)) {
            $.ajax({
                url: 'permintaan_pakan_v2/permintaan_pakan/datafarm/' + id + '/' + kode_siklus,
                beforeSend: function() {
    ...
    get_last_pp: function(flok) {
        ...
        $.ajax({
            url: 'permintaan_pakan_v2/permintaan_pakan/get_last_pp/' + kodeflok,
            type: 'get',
            dataType: 'json',
            success: function(data) {
                if (data.status) {
    ...
    get_last_pp_noreg: function(noreg, kodeflok) {
        var _result = {};
        $.ajax({
            url: 'permintaan_pakan_v2/permintaan_pakan/get_last_pp_noreg/',
            data: { noreg: noreg },
            type: 'get',
            dataType: 'json',
            success: function(data) {
    ...
    rencanaTanggalPanen: function(noreg, tglKebutuhanAwal) {
        ...
        if (!_rencanaPanen.length) {
            var _url = 'permintaan_pakan_v2/permintaan_pakan/rencanaPanen';
    ...
    showInfoHistory: function(elm) {
        if (empty($.trim($('div#tableBudgetPakan').html()))) {
            ...
            $.ajax({
                url: 'permintaan_pakan_v2/permintaan_pakan/historyInfoPP',
                beforeSend: function() {
                    $('div#tableBudgetPakan').html('');
                    $('div#tablePerformaKandang').html('');
                    $('div#tableRiwayatPP').html('');
    ...
    get_sisa_budget: function(_noreg) {
        ...
        if (this._sisaBudget[_noreg] == undefined) {
            $.ajax({
                url: 'permintaan_pakan_v2/permintaan_pakan/getSisaBudget',
                data: { no_reg: _noreg },
                type: 'get',
                dataType: 'json',
                success: function(data) {
    ...
    save_server: function() {
        ...
        $.ajax({
            ...
            url: 'permintaan_pakan_v2/permintaan_pakan/simpan_pp',
            success: function(data) {
                ...
                if (data.status) {
                    ...
                    if (data.createop) {
                        $.post('permintaan_pakan_v2/permintaan_pakan/approve_pp_budidaya', { no_pp: [data.content] }, function(data) {
                            if (data.status) {
    ...
    transaksi_pp: function(elm, target) {
        ...
        $.ajax({
            ...
            url: 'permintaan_pakan_v2/permintaan_pakan/transaksi_pp',
            dataType: 'html',
            async: false,
            success: function(data) {
                $('#transaksi').html(data);
    ...
    showModalTambahPakan: function(elm, showCekbox) {
        ...
        bootbox.dialog(_options).bind('shown.bs.modal', function() {
            ...
            $.ajax({
                ...
                type: 'post',
                url: 'permintaan_pakan_v2/permintaan_pakan/get_pakan_tambahan',
                dataType: 'json',
                success: function(data) {
                    if (data.status) {
    ...
    set_pakan_tambahan: function(elm, _awalGanti, _akhirTambah, _kodePakan, defaultValue) {
        ...
        $.ajax({
            url: 'permintaan_pakan_v2/permintaan_pakan/pakan_tambahan',
    ...
    get_hari_libur: function(minDate) {
        if (this._hari_libur == null) {
            $.ajax({
                ...
                type: 'post',
                url: 'permintaan_pakan_v2/permintaan_pakan/get_hari_libur',
                success: function(data) {
                    if (data.status) {
    ...
    list_pp_farm: function() {
        ...
        $.ajax({
            url: 'permintaan_pakan_v2/permintaan_pakan/list_pp_farm',
            type: 'post',
            dataType: 'json',
            async: false,
            cache: false,
    ...
    cek_input_lhk: function(flok) {
        ...
        var _result = {};
        $.ajax({
            url: 'permintaan_pakan_v2/permintaan_pakan/cek_input_lhk/' + kodeflok,
            type: 'post',
            dataType: 'json',
            async: false,
            cache: false,
    ...
    cek_input_lhk_noreg: function(noreg) {
        var _result = {};
        $.ajax({
            url: 'permintaan_pakan_v2/permintaan_pakan/cek_input_lhk_noreg/',
            data: { no_reg: noreg },
            type: 'post',
            dataType: 'json',
            async: false,
    ...
    list_pp_cari: function(elm) {
        ...
        $.ajax({
            ...
            url: 'permintaan_pakan_v2/permintaan_pakan/list_pp/ajax',
            dataType: 'html',
            async: false,
            success: function(data) {
    ...
    list_monitoring_pp_cari: function(elm) {
        ...
        if (!_error) {
            $.ajax({
                ...
                url: 'permintaan_pakan_v2/permintaan_pakan/list_monitoring_pp',
                dataType: 'html',
                async: false,
                success: function(data) {
    ...
    get_tgl_kirim_forecast: function(kodeFlokBdy, tglkebAwal) {
        ...
        if (empty(this._tgl_kirim_forecast[kodeFlokBdy][tglkebAwal])) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'json',
                url: 'permintaan_pakan_v2/permintaan_pakan/tanggal_kirim_forecast',
                success: function(data) {
                    if (data.status) {
        ...
        if (!_error) {
            ...
            if (!empty(_listPP)) {
                $.ajax({
                    ...
                    url: 'permintaan_pakan_v2/permintaan_pakan/reject_pp_kadiv',
                    success: function(data) {
                        if (data.status) {
                            bootbox.hideAll();
                            toastr.success(data.message);
