						...
						<form class="form form-horizontal">
							<div class="form-group ckTindaklanjut">
								<div class="col-md-offset-3 col-md-8 checkbox">
									<label>
										<input type="checkbox">Belum Selesai Proses
									</label>
								</div>
							</div>
<!--							
...
-->	
							...
							<div class="form-group" style="margin-top:-20px">
								<div class='col-md-1 col-md-offset-3'>
								 	<span class="btn btn-default" onclick="Pengirimanreturpakanfarm.cari()">Cari</span>
						   	 	</div>								
							</div>
	...
	<div class="panel-heading">Daftar Pengiriman Retur Pakan Antar Farm</div>
	<div class="panel-body">
		<div id="div_pengiriman_retur_pakan"></div>
	</div>
</div>
<div id="div_detail_pengiriman_retur_pakan"></div>		
</div>
</div>
...
<script type="text/javascript" src="assets/js/rekap_retur_pakan/pengiriman_retur_pakan_farm.js"></script>