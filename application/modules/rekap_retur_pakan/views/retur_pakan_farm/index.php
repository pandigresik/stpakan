...
<div  id="main_page_retur">
						...
						<form class="form form-horizontal">
							<div class="form-group ckTindaklanjut">
								<div class="col-md-offset-3 col-md-8 checkbox">
									<label>
										<input type="checkbox">Retur pakan belum ditindaklanjuti
									</label>
								</div>
							</div>	
							...
							<div class="form-group" style="margin-top:-20px">
								<div class='col-md-1 col-md-offset-3'>
								 	<span class="btn btn-default" onclick="Returpakanfarm.cari()">Cari</span>
						   	 	</div>								
							</div>
	...
	<div class="panel-heading">Daftar Retur Pakan Antar Farm</div>
