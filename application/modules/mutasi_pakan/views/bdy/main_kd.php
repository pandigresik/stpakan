<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form form-horizontal" id="form_input">
            ...
            <div class="form-group">
                <label style="text-align: left;" class="control-label col-md-2">Nama Farm</label>
                <div class="col-md-2">
                    <select class="form-control" name="farm" id="farm" onchange="get_data_kandang()">
                        <option value="">Pilih</option>
                        <?php foreach ($data_farm as $key => $value) { ?>
                            <option value="<?php echo $value['KODE_FARM'] ?>"><?php echo $value['NAMA_FARM'] ?></option>
                        <?php } ?>
                    </select>
                </div>
                <label style="text-align: left;" class="control-label col-md-2 col-md-offset-1">Kandang</label>
                <div class="col-md-2">
