            ...
            if (!empty(mydata.length)) {
                if (mydata.length > 0) {
                    ...
                    $.each(record_par_page, function(key, data) {
                        ...
                        $("#daftar-do-table table tbody").append('<tr ondblclick="baru(this,1)" data-no-do="'+data.no_do+'" class="'+pink+'"><td>' + data.no_op + '</td><td>' + data.no_do + '</td><td>' + data.no_sj + '</td><td>' + data.nama_ekspedisi + '</td><td>' + _tgl_kirim + '</td><td>' + _tgl_terima + '</td><td>' + tmp_jam_terima.substring(0,5) + '</td><td>' + data.penerima + '</td>' + td_ba + '</tr>');
