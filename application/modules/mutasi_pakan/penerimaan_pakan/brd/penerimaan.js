        ...
        if (!empty(mydata.length)) {
            if (mydata.length > 0) {
                ...
                $.each(record_par_page, function(key, data) {
                    ...
                    $("#daftar-do-table table tbody").append('<tr class="'+pink+'"><td>' + data.no_op + '</td><td>' + data.no_do + '</td><td>' + data.no_sj + '</td><td>' + data.nama_ekspedisi + '</td><td>' + Config._tanggalLocal(Config._getDateStr(new Date(data.tanggal_kirim)),'-',' ') + '</td><td>' + Config._tanggalLocal(Config._getDateStr(new Date(data.tanggal_terima)),'-',' ') + '</td><td>' + data.jam_terima + '</td><td>' + data.penerima + '</td><td>' + data.no_ba + '</td></tr>');
