<?php
	...
	if($header){
		...
		foreach($list_kertas_kerja as $kk){
			...
			$b_barang_tampil_asli = (empty($kk['pp_b_kode_barang'])) ? $kk['b_barang'] : $kk['pp_b_kode_barang'];
			$j_barang_tampil_asli = (empty($kk['pp_j_kode_barang'])) ? $kk['j_barang'] : $kk['pp_j_kode_barang'];
