...
<div class="row">
	<?php if($canImport){ ?>
		<div class="col-md-5" id="import_div">
			<div class="panel panel-default">
				<div class="panel-heading">Import Perencanaan DOC In <span class="pull-right"><a href="file_upload/doc.xls" target="_blank" >Contoh file</a></span></div>
				<div class="panel-body">
					<div class="col-md-12 ">
	...
	<?php } ?>
		<div class="col-md-7" id="preview_div">
			<div class="panel panel-default">
						      ...
						      <div class="form-group">
		      					<div class="col-md-4 col-md-offset-1">
		      						<div class="row">
		      							...
		      							<div class="col-md-6">
		      								<div class="input-group">
		      									<input type="text" name="dayahidup" class="form-control col-md-4" />
		      					...
		      					<div class="col-md-4">
		      						<div class="row">
		      							...
		      							<div class="col-md-6">
		      								<input type="text"  name="fcr" class="form-control col-md-2" />
		      							</div>
		      						</div>
		      					</div>
		      					<div class="col-md-3">
		      						<div class="row">
		      							...
		      							<div class="col-md-6">
		      								<input type="text"  name="ip" class="form-control col-md-2" />
		      							</div>
		      						</div>
		      					</div>
		      				</div>
		      				  <div class="form-group">
		      					<div class="col-md-4 col-md-offset-1">
		      						<div class="row">
		      							...
		      							<div class="col-md-6">
		      								<div class="input-group">
		      									<input type="text"  name="beratbadan" class="form-control col-md-4" />
		      					...
		      					<div class="col-md-4">
		      						<div class="row">
		      							...
		      							<div class="col-md-6">
		      								<div class="input-group">
		      									<input type="text"  name="umurpanen" class="form-control col-md-4" />
		      					...
		      					<div class="col-md-3">
		      						<div class="row">
		      							...
		      							<div class="col-md-6">
		      								<input type="text"  name="kum" class="form-control col-md-2" />
		      							</div>
		      						</div>
		      					</div>
		      				</div>
