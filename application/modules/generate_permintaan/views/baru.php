            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group hide">
                        <label for="" class="col-md-2 control-label"><p class="text-left">Data
                                Hide</p></label>
                    ...
                    <div class="form-group">
                        <label for="" class="col-md-2 control-label"><p class="text-left">Kode
                                Farm</p></label>
                    ...
                    <div class="form-group">
                        <label for="" class="col-md-2 control-label"><p class="text-left">Tanggal
                                Kirim</p></label>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-1 control-label" for=""><p
                                class="text-center">s/d</p></label>
                        <div class="col-md-2">
                            <div class="input-group">
                                <input type="text" class="form-control"
