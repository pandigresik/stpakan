<table class="table table-bordered custom_table">
	<thead>
		...
		<tr>
			...
			<th>Tanggal/Jam Review Presdir</th>
			<th>Sisa Hutang</th>
		</tr>
	</thead>
	<tbody>
		...
		<?php 
			...
			if(!empty($list_retur)){
				foreach($list_retur as $retur){
					...
					echo '<tr onclick="Approval.showdetailretur(this)" data-aktif="'.$aktif.'" data-id_retur="'.$retur['id'].'" data-no_retur="'.$retur['no_retur'].'" data-keputusan="'.$retur['keputusan'].'">
