...
class Permintaan_pakan extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('permintaan_pakan_v3/m_permintaan_pakan', 'mpp');
    ...
    public function kepala_farm($farm = null)
    {
        ...
        $this->load->view('permintaan_pakan_v3/permintaan_pakan', $data);
    }
    ...
    public function kadiv($farm = null)
    {
        ...
        $this->load->view('permintaan_pakan_v3/bdy/approvalpp', $data);
    }
    ...
    public function datafarm($idFarm, $kodeSiklus)
    {
        ...
        $this->load->view('permintaan_pakan_v3/'.$this->grup_farm.'/farm', $data);
    }
    ...
    public function list_pp($return = 'html')
    {
        ...
        $this->load->model('permintaan_pakan_v3/m_lpb', 'lpb');
        ...
        if ($return == 'data') {
            ...
            if ($return == 'ajax') {
                ...
                $this->load->view('permintaan_pakan_v3/'.$this->grup_farm.'/'.$view_pp, $data);
            } else {
                return $this->load->view('permintaan_pakan_v3/'.$this->grup_farm.'/'.$view_pp, $data, true);
            }
        }
    }
    ...
    {
        $this->load->model('permintaan_pakan_v3/m_lpb', 'lpb');
        $this->load->model('permintaan_pakan_v3/m_lpbd', 'lpbd');
        $idfarm = $this->session->userdata('kode_farm');
...
SQL;
    ...
    private function _simpanDetail($no_pp, $dataHeader, $dataDetail, $review, $kodefarm, $statusLpb, $autoApprove)
    {
        ...
        $this->load->model('permintaan_pakan_v3/m_lpbe', 'lpbe');
        foreach ($dataDetail[0] as $baris) {
    ...
    private function _hapusDetail($no_pp)
    {
        $this->load->model('permintaan_pakan_v3/m_lpbd', 'lpbd');
        $this->load->model('permintaan_pakan_v3/m_lpbe', 'lpbe');
        $this->load->model('permintaan_pakan_v3/m_review_lpb', 'review');
...
SQL;
    ...
    public function transaksi_pp($no_lpb = null, $status_pp = null, $no_flok_pp = null)
    {
        ...
        $this->load->view('permintaan_pakan_v3/'.$this->grup_farm.'/transaksi', $data);
    }
    ...
    private function list_kebutuhan_pakan_bdy()
    {
        ...
        if (!empty($no_lpb)) {
            /* cari data review */
            $this->load->model('permintaan_pakan_v3/m_review_lpb', 'rl');
        ...
        switch ($user_level) {
            case 'KDV':
                ...
                $data['kebutuhan_pakan'] = $this->load->view('permintaan_pakan_v3/'.$grup_farm.'/kebutuhan_pakan', array(
                    'kebutuhan_pakan' => $tmp,
                ...
                $kebutuhan_internal = $this->load->view('permintaan_pakan_v3/'.$grup_farm.'/permintaan_kebutuhan_internal', $data, true);
                break;
            default:
                $data = array(
                    'kebutuhan_pakan' => '',
    ...
    public function historyInfoPP()
    {
        ...
        $budget_pakan = $this->load->view('permintaan_pakan_v3/bdy/permintaan_sisa_pakan', $data_sisa_pakan, true);
        $this->load->model('permintaan_pakan_v3/m_lpbe', 'lpbe');
        ...
        $riwayat_pp = $this->load->view('permintaan_pakan_v3/bdy/riwayat_pp', $data_riwayat, true);
        $performa_kandang = $this->load->view('permintaan_pakan_v3/bdy/performa_kandang', $data_performa, true);
        echo json_encode(array(
            'status' => 1,
    ...
    public function comparepp()
    {
        ...
        if (!empty($compare)) {
            ...
            $this->load->view('permintaan_pakan_v3/'.$this->grup_farm.'/comparepp', $data);
        }
    }
    ...
    public function monitoring_pp($farm = null)
    {
        ...
        $this->load->view('permintaan_pakan_v3/monitoring', $data);
    }
    ...
    public function list_monitoring_pp()
    {
        ...
        $this->load->view('permintaan_pakan_v3/'.$gf.'/monitoring_list_pp', $data);
    }
    ...
    public function pakan_tambahan()
    {
        ...
        $this->load->view('permintaan_pakan_v3/bdy/kebutuhan_pakan',
            array(
    ...
    public function rencanaPanen()
    {
        ...
        $this->load->view('permintaan_pakan_v3/bdy/rencana_panen', $data);
    }
}
