		...
		<div class="col-md-10 new-line" id="tabel_pp">
			<table class="table table-bordered  new-line" >
				...
				<tr data-tgl_kirim="<?php echo tglIndonesia($baris['TGL_KIRIM'],'-',' ')?>">
						...
						<td><span class="btn btn-default pilih_btn exist" data-hitung_ulang="<?php echo $bisaHitungUlang ?>" data-no_pp="<?php echo isset($pp['NO_LPB']) ? $pp['NO_LPB'] : '' ?>" onclick="Permintaan.list_kebutuhan_pakan(this)">Pilih</span></td>
					</tr>
				<?php 	}
					}
					else{
				?>	
					<tr>
						...
						<td><span class="btn btn-default pilih_btn  new" data-hitung_ulang="1" data-no_pp="" onclick="Permintaan.list_kebutuhan_pakan(this)">Pilih</span></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
...
<script type="text/javascript" src="assets/js/permintaan_pakan_v3/transaksi.js"></script>
