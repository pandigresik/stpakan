<div id="list_farm" class="header text-center row"><div name="divFarm" class="col-md-4 col-md-offset-4"><h3><?php echo $list_farm ?></h3></div></div>
...
<script type="text/javascript" src="assets/js/permintaan_pakan_v3/permintaan_pakan.js"></script>
