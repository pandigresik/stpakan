	...
	<div class="row col-md-10">
		...
		<div class="form form-horizontal" id="form_input">
			...
			<div class="form-group">
				<label class="control-label col-md-2" style="text-align: right;">No. SO</label>
				<div class="col-md-10">
					<div class="form-inline">
						<div class="form-group col-md-3">
							<div class="input-group">
								<input type="text" class="form-control" name="nomorSO" placeholder="" value="" onkeyup="plottingKendaraan.searchSO(this)" />
						...
						<div class="checkbox col-md-3" style="margin-left:3px">
							<label><input type="checkbox" value="" name="statusSO" onchange="plottingKendaraan.searchSO(this)" /> SO/DO telah diplotting</label>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="assets/js/sales_order/plotting_kendaraan.js"></script>
