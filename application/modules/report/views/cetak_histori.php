			...
			<td align="left">
				...
				<table width="400" border="1">
					...
					<tr>
						<td height="50">
							<table>
								<?php if($status_lsgas == 'N'||$status_lsgas == 'R'||$status_lsgas == 'A1'||$status_lsgas == 'A2'){?>
								<tr><td height="40">
									<img src="http://localhost/stpakan/assets/images/approved.png" alt="DataTables logo">
								</td></tr>
								<tr><td align="center"><b><?php echo $rilis_by?></b></td></tr>
								<?php }?>
							</table>
						</td>
						<td>
							<table>
								<?php if($status_lsgas == 'R'||$status_lsgas == 'A1'||$status_lsgas == 'A2'){?>
								<tr><td height="40">
									<img src="http://localhost/stpakan/assets/images/approved.png" alt="DataTables logo">
								</td></tr>
								<tr><td align="center"><b><?php echo $review_by?></b></td></tr>
								<?php }?>
							</table>
						</td>
						<td>
							<table>
								<?php if($status_lsgas == 'A1' || $status_lsgas == 'A2'){?>
								<tr><td height="40">
									<img src="http://localhost/stpakan/assets/images/approved.png" alt="DataTables logo">
								</td></tr>
								<tr><td align="center"><b><?php echo $approve_by?></b></td></tr>
								<?php }?>
							</table>
						</td>
						<td>
							<table>
								<?php if($status_lsgas == 'A2'){?>
								<tr><td height="40">
									<img src="http://localhost/stpakan/assets/images/approved.png" alt="DataTables logo">
								</td></tr>
								<tr><td align="center"><b><?php echo $ack_by?></b></td></tr>
								<?php }?>
							</table>
						</td>
					</tr>
				...
				<table border="0" cellpadding="2">
					...
					<?php
						...
						foreach ($budget_internal as $data) {
							echo '<tr>
								...
								<td width="200">'.$data->NAMA_BUDGET.'</td>
								<td width="50" align="right" style="border-bottom: 1px solid #000">'.$data->JML_ORDER.'</td>
								<td>lembar</td>
							</tr>';
							$total_pakai_internal += $data->JML_ORDER;
							$number++;
						}
					?>
					<tr>
					...
					<?php
						...
						foreach ($budget_eksternal as $data) {
							...
							$total_pakai_eksternal += $data->JML_ORDER;
							$number++;
						}
					?>
					<tr>
