			...
			?>
				<div class="row container">
					<div class="col-md-4 new-line">
						<div class="btn btn-default hide" id="tampilkan_btn" onclick="Rhk.showListFarm(this,'lsam')">Tampilkan</div>
						...
						<div class="btn btn-default" onclick="Rhk.showInformasi(this,'lsam')">Informasi</div>
					</div>
				</div>
</form>
