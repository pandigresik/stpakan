      ...
      <div class="row">
  			<div class="col-sm-12">
  				<form class="form-horizontal">
		              ...
		              <div class="col-sm-2">
		                <select class="form-control" id="search_status" data-required="1" placeholder="Status" onchange="KSG.tampilkan()">
					  ...
					  <?php if(count($list_farm) > 1):?>
						  <div class="col-sm-2">
			                <select class="form-control" id="search_farm" data-required="1" placeholder="Status" onchange="KSG.tampilkan()">
				  	  ...
				  	  <?php else:?>
						  <input type="hidden" id="search_farm" value="<?php print_r($list_farm[0]->KODE_FARM)?>">
				  	  <?php endif;?>

		  			  <!-- <button type="button" class="btn btn-primary" onclick="KSG.tampilkan()"> <i class="fa fa-search"></i> Tampilkan </button> -->
  					</div>
  				</form>
  			</div>
      </div>
    ...
    <div class="row col-sm-12">
      <caption>
        <div>
          ...
          <!-- <button type="button" class="btn btn-default" onclick="KSG.print(this)"> <i class="fa fa-print"></i> Cetak </button> -->
...
<script type="text/javascript" src="assets/js/report/tu_ksg.js"></script>
