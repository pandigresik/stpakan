<div class="row">
<div class="col-md-4 col-md-offset-4 text-center"><h3>LAPORAN STOK AYAM MINGGUAN</h3></div>
</div>
<div>
			...
			?>
				<div class="row container">
					<div class="col-md-4 new-line">
						<div class="btn btn-default hide" id="tampilkan_btn" onclick="Rhk.showListFarm(this,'lsam_flock')">Tampilkan</div>
						<span class="btn btn-default" onclick="Rhk.exportSpreadsheet('Laporan Stok Ayam Mingguan.zip')">Export to xls</span>
						...
						<div class="btn btn-default" onclick="Rhk.showInformasi(this,'lsam_flock')">Informasi</div>
					</div>
				</div>
</form>
