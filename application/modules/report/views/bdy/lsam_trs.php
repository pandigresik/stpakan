			...
			?>
				<div class="row container">
					<div class="col-md-4 new-line">
						<div class="btn btn-default hide" id="tampilkan_btn" onclick="Rhk.showRhkTrs(this,'lsam_trs')">Tampilkan</div>
						<span class="btn btn-default" onclick="Rhk.exportSpreadsheetTrs('Laporan Stok Ayam Mingguan.zip')">Export to xls</span>
						...
						<div class="btn btn-default" onclick="Rhk.showInformasi(this,'lsam_trs')">Informasi</div>
					</div>
				</div>
</form>
