<table class="table table-bordered custom_table" >
	<thead>
			<tr>
				...
				<th class="screen_3" colspan="5">Pakan</th>
				<th class="screen_3" colspan="3">Berat Badan</th>
				<th class="screen_4" colspan="3">ADG</th>
				<th class="screen_4" colspan="3">FCR</th>
				<th class="screen_4" colspan="3">IP</th>
			</tr>
			<tr>
				...
				<th class="screen_3" colspan="2">Pakai</th>
				<th class="screen_3" rowspan="2">Kumulatif (gr)</th>
				<th class="screen_3" rowspan="2">Std (gr)</th>
				<th class="screen_3" rowspan="2">(%) dr Std</th>
				<th class="screen_3" rowspan="2">Real (gr)</th>
				<th class="screen_3" rowspan="2">Std (gr)</th>
				<th class="screen_3" rowspan="2">(%) dr Std</th>
				<th class="screen_4" rowspan="2">Real (gr)</th>
				<th class="screen_4" rowspan="2">Std (gr)</th>
				<th class="screen_4" rowspan="2">(%) dr Std</th>
				<th class="screen_4" rowspan="2">Real</th>
				<th class="screen_4" rowspan="2">Std</th>
				<th class="screen_4" rowspan="2">(%) dr Std</th>
				<th class="screen_4" rowspan="2">Real</th>
				<th class="screen_4" rowspan="2">Std</th>
				<th class="screen_4" rowspan="2">(%) dr Std</th>
			...
			<tr>
				...
				<th class="screen_3">gr</th>
			</tr>
		</thead>
		<tbody>
			<?php
		foreach($farms as $f => $farm){
			echo '<tr style="background-color:#d9edf7"><td colspan="4" style="text-align:left;"><strong>Farm '.$nama_farm[$f].' ('.$f.' '.count($farm).' Kandang)</strong></td><td colspan="10" class="screen_2"></td><td colspan="10" class="screen_3"></td><td colspan="11" class="screen_4"></td></tr>';
			...
			echo '<tr style="background-color:#ffffcc"><td colspan="4" style="text-align:left;"><strong>'.$kd.'</strong></td><td colspan="10" class="screen_2"></td><td colspan="10" class="screen_3"></td><td colspan="11" class="screen_4"></td></tr>';
				...
				if(!empty($rhk)){
					...
					foreach($rhk as $tgl =>$r){
						...
						$pakai_gr_perekor = $r['jml'] > 0 ? $pakai_kg / $r['jml'] : 0;
						$pakai_kumgr_perekor = $r['jml'] > 0 ? $pakai_kum / $r['jml'] : 0;
						...
						echo '<td  class="number screen_3">'.$pakai_sak.'</td>';
						echo '<td  class="number screen_3">'.formatAngka($pakai_gr_perekor,3).'</td>';
						echo '<td  class="number screen_3">'.formatAngka($pakai_kumgr_perekor,0).'</td>';
						echo '<td  class="number screen_3">'.$r['pkn_kum_std'].'</td>';
						echo '<td  class="number screen_3">'.$pkn_rasio.'</td>';
						...
						echo '<td  class="number screen_4">'.formatAngka($r['adg'],1).'</td>';
						echo '<td  class="number screen_4">'.formatAngka($r['adg_std'],0).'</td>';
						echo '<td  class="number screen_4">'.$adg_rasio.'</td>';
						echo '<td  class="number screen_4">'.formatAngka($r['fcr'],3).'</td>';
						echo '<td  class="number screen_4">'.formatAngka($r['fcr_std'],3).'</td>';
						echo '<td  class="number screen_4">'.$fcr_rasio.'</td>';
						echo '<td  class="number screen_4">'.$r['ip'].'</td>';
						echo '<td  class="number screen_4">'.$r['ip_std_umur'].'</td>';
						echo '<td  class="number screen_4">'.$ip_rasio.'</td>';
						echo '</tr>';
	...
	<div class="btn prev slider-table" data-current="2" data-min="2" data-max="4" onclick="Rhk.prev(this)"> <i class="glyphicon glyphicon-chevron-left"></i> </div>
	<div class="btn next slider-table" data-current="2" data-min="2" data-max="4" onclick="Rhk.next(this)"> <i class="glyphicon glyphicon-chevron-right"></i> </div
