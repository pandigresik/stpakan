		...
		?>
				<div class="row container">
					<div class="col-md-4 new-line">
						<div class="btn btn-default hide" id="tampilkan_btn" onclick="Rhk.showRhkTrs(this,'rhk_trs')">Tampilkan</div>
						...
						<div class="btn btn-default" onclick="Rhk.showInformasi(this,'rhk_trs')">Informasi</div>
					</div>
				</div>
</form>
...
<link rel="stylesheet" type="text/css" href="assets/css/report/stok_pakan.css?v=3.1" >
