							...
							<table class="table table-bordered tbl-sub-detail-penerimaan">
								...
								<tbody>
                                    ...
                                    <tr class="tr-sub-detail"
										...
										<td class="selesai"
											data-selesai="<?php echo $value['selesai']; ?>"><?php echo $value['selesai'] == 0 ? '<button class="btn btn-default" type="button" onclick="selesai(this)" disabled>Selesai</button>' : 'Selesai'; ?></td>
									</tr>
                                    <?php $detail++; ?>
                                    <?php } ?>
                                </tbody>
