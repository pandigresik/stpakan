...
class Pembelian_pakan extends MY_Controller
{
    ...
    public function approve($farm = null)
    {
        ...
        $this->load->view('permintaan_pakan_v2/bdy/approve_do', $data);
    }
    ...
    public function order($rekap = 0)
    {
        ...
        $data['farm'] = $namaFarm;
        $this->load->view('permintaan_pakan_v2/order_pembelian', $data);
    }

    public function list_order()
    {
        $this->load->model('permintaan_pakan_v2/m_do', 'mdo');
        ...
        $this->load->view('permintaan_pakan_v2/list_order', $data);
    }
    ...
    public function list_order_approve()
    {
        ...
        $this->load->view('permintaan_pakan_v2/list_order_approve', $data);
    }

    public function detail_pp()
    {
        /* dapatkan semua informasi pp berdasarkan nomer pp */
        $this->load->model('permintaan_pakan_v2/m_op_vehicle', 'mopv');
        ...
        $this->load->view('permintaan_pakan_v2/transaksi_detail_pp', $data);
    }
    ...
    public function simpan_do()
    {
        ...
        /* insert ke tabel op */
        $this->load->model('permintaan_pakan_v2/m_do', 'mdo');
        $this->load->model('permintaan_pakan_v2/m_do_d', 'mdod');
        $this->load->model('permintaan_pakan_v2/m_op_vehicle', 'mopv');
        $this->load->model('permintaan_pakan_v2/m_log_ploting_do', 'lpd');
        ...
        if (!empty($do)) {
            foreach ($do as $no_op => $do_perop) {
                ...
                foreach ($do_perop as $kode_ekspedisi => $do_perekspedisi) {
                    ...
                    foreach ($do_perekspedisi as $_do) {
                        $rit = $_do['rit'];
                        unset($_do['rit']);
    ...
    public function detail_do()
    {
        ...
        $data['list_do'] = $result;
        $this->load->view('permintaan_pakan_v2/cetak_do', $data);
    }

    public function cetak_order_penjualan()
    {
        $this->load->view('permintaan_pakan_v2/order_penjualan_marketing');
    }

    public function cetak_order_pembelian()
    {
        $this->load->view('permintaan_pakan_v2/order_pembelian_logistik');
    }
    ...
    public function list_order_penjualan_marketing()
    {
        ...
        $this->load->view('permintaan_pakan_v2/list_order_penjualan_marketing', $data);
    }
    ...
    public function list_order_pembelian_logistik()
    {
        ...
        $data['order_pembelian'] = $list_order_logistik;
        $this->load->view('permintaan_pakan_v2/list_order_pembelian_logistik', $data);
    }
    ...
    public function order_pembelian_print()
    {
        ...
        $this->load->view('permintaan_pakan_v2/cetak_order_pembelian_print', array(
    ...
    public function order_penjualan_pdf()
    {
        ...
        $html = $this->load->view('permintaan_pakan_v2/cetak_order_penjualan_pdf', array(
    ...
    public function do_pdf($_no_do = null, $asAttachment = 0)
    {
        ...
        foreach ($result as $do) {
            ...
            $html = $this->load->view('permintaan_pakan_v2/cetak_do_pdf', array(
                    'data_do' => $do,
                    'barcode' => $b,
            ), true);
            $pdf->AddPage();
...
sbj;
    ...
    public function downloadPdfDO($kodeFarm,$tglKirim = NULL){
		$tmp = $this->db->select('no_do')->where(array('kode_farm' => $kodeFarm, 'tgl_kirim' => $tglKirim))->get('do')->result_array();
		$dos = array_column($tmp,'no_do');
		$this->load->library('zip');
=======
		//$dos = array('DO/JD/2018-0052');	
		$subject = <<<sbj
